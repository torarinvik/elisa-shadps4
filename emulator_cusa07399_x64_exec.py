...
def main() -> int:
    ...
    if errors:
        emit(
            ...
            guardrail_debug_trap_return_addr=artifact_get(artifacts, "guardrail_debug_trap_return_addr"),
            guardrail_debug_trap_arg0=artifact_get(artifacts, "guardrail_debug_trap_arg0"),
            guardrail_debug_trap_arg1=artifact_get(artifacts, "guardrail_debug_trap_arg1"),
            guardrail_debug_trap_arg2=artifact_get(artifacts, "guardrail_debug_trap_arg2"),
            guardrail_debug_trap_pointer_size=artifact_get(artifacts, "guardrail_debug_trap_pointer_size"),
            guardrail_debug_trap_nearest_mapping_base=artifact_get(artifacts, "guardrail_debug_trap_nearest_mapping_base"),
            guardrail_debug_trap_nearest_mapping_end=artifact_get(artifacts, "guardrail_debug_trap_nearest_mapping_end"),
            guardrail_debug_trap_nearest_mapping_prot=artifact_get(artifacts, "guardrail_debug_trap_nearest_mapping_prot"),
